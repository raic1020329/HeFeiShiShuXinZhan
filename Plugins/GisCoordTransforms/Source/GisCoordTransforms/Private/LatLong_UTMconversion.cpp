	...
	double &UTMNorthing, double &UTMEasting, char* UTMZone)
{
	...
	double er = ellipsoid[ReferenceEllipsoid].EquatorialRadius;
	...
	M = er * ((1 - eccSquared / 4 - 3 * eccSquared*eccSquared / 64 - 5 * eccSquared*eccSquared*eccSquared / 256)*LatRad
	...
	double& Lat, double& Long)
{
	...
	M = y / k0;
	mu = M / (er*(1 - eccSquared / 4 - 3 * eccSquared*eccSquared / 64 - 5 * eccSquared*eccSquared*eccSquared / 256));
